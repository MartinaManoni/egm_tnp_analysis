...
tnpParAltSigFit = [
    "meanP[-0.0,-2.0,5.0]","sigmaP[1,0.7,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[1,0.5,5.0]",
    "meanF[-0.0,-3.0,5.0]","sigmaF[1,0.7,25.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[1.5,0.5,6.0]","sosF[1,0.5,5.0]",
    ...
    #"{a0[-0.3,-0.8,-0.2],a1[0.,-0.5,0.5],a2[0.,-0.08,0.08],a3[0., -0.7, 0.7]}",#27
    ]
