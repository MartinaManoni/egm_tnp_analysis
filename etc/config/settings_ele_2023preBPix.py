...
tnpParNomFit = [
    ...
    #"{a0[-0.9,-1.5,-0.5],a1[0.,-0.5,0.5],a2[0.,-0.09,0.09],a3[0, -0.5, 0.5]}", #bins 0-2 4-5 a2[0.,-0.04,0.04], bin 3 a2[0.,-0.1,0.1] bin 6 a2[0.,-0.06,0.06], bin 7 a2[0.,-0.09,0.09]
    ]
...
tnpParAltSigFit = [
    "meanP[-0.0,-2.0,5.0]","sigmaP[1,0.7,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[1,0.5,5.0]",
    "meanF[-0.0,-2.0,5.0]","sigmaF[1.0,0.7,6.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[1,0.5,5.0]",
    "acmsP[60.,50.,75.]","betaP[0.04,0.001,0.1]","gammaP[0.1, 0.005, 1]","peakP[90.0]", #bin 22 betaP[0.04,0.001,0.1]
    #"{a0[-0.9,-1.5,-0.5],a1[0.,-0.5,0.5],a2[0.,-0.1,0.1],a3[0, -0.1, 0.1]}", #a2[0.,-0.1,0.1] bin 3 a2[0.,-0.2,0.2] bin 5 a2[0.,-0.05,0.05] bin 6 a2[0.,-0.1,0.1] bin 7
    "acmsF[60.,50.,75.]","betaF[0.06,0.001,0.9]","gammaF[0.25, 0.001, 5.0]","peakF[90.0]",
    ]
'''
...
tnpParAltBkgFit = [
    ...
    "meanF[-0.0,-10.0,10.0]","sigmaF[0.9,0.5,5.0]",
    #"meanF[-0.7]","sigmaF[0.9,0.5,5.0]", #-0.87 bin 14/15 
    "alphaP[0.,-5.,5.]",
    "alphaF[-0.,-0.20,-0.012]", #"alphaF[-0.040]", bin 14/15
    #"a0[2,0.5,7.5]","a1[2,10,40]","a2[7,2,60]",  #2023 preBPix: Gamma bin 0/1/5/6
    #"a0[2,0.5,7.5]","a1[7.5,6,40.7]","a2[15,10,62]", #2023 preBPix: Gamma bin 2/3/4/
...
tnpParAltSigBkgFit = [
    ...
    #"a0[2,0.5,7.5]","a1[7.5,6,40.7]","a2[5,10,50]", #2023 preBPix: 0/4/5/6
