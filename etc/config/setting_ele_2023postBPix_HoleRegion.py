...
baseOutDir = '/eos/user/m/mmanoni/Tnp_results_2023postBPix_HOLE_REGION/hzzSummer18UL/HOLE_2023postBPixResults_sipdzdxy_el3charge_cut60'
...
#############################################################
tnpParNomFit = [
    #"meanP[-0.0,-2.0,2.0]","sigmaP[4.5,4.,5.0]", #bin 2/3/4/12
    "meanP[-0.0,-2.0,2.0]","sigmaP[2.,2.,4.0]", #bin 14
    #"meanP[-0.0,-2.0,2.0]","sigmaP[0.9,0.5,5.0]", #original
    #"meanF[-0.0,-5.0,5.0]","sigmaF[0.9,0.5,5.0]", # "meanF[-0.0,-5.0,5.0]","sigmaF[0.9,0.5,5.0]",
    
    "meanF[-0.0,-5.0,5.0]","sigmaF[2.,2.,4.0]",
    #"meanF[-0.0,-5.0,5.0]","sigmaF[4.5,4.,5.0]",#bin 0
    #"meanF[-0.0,-5.0,5.0]","sigmaF[5.5,5.,7.0]",#bin 0/2/3/4
    #"meanF[-0.0,-5.0,5.0]","sigmaF[6.5,6.,7.0]",#bin 0/2/3/4
    "acmsP[60.,50.,80.]","betaP[0.05,0.01,0.08]","gammaP[0.1, -2, 2]","peakP[90.0]",#20-29  betaP[0.05,0.01,0.2]
    #"acmsF[60.,50.,80.]","betaF[0.05,0.01,0.1]","gammaF[0.5, -2, 2]","peakF[90.0]",
    #"{a0[-0.9,-1.5,-0.5],a1[0.,-0.5,0.5],a2[0.,-0.09,0.09],a3[0, -0.5, 0.5]}", #bins 0/1/2/3/4

    "{a0[-0.9,-1.5,-0.],a1[0.,-0.5,0.5],a2[0.,-0.09,0.09],a3[0, -0.1, 0.1]}", #bin 25

    #"{a0[-0.9,-1.5,-0.5],a1[0.,-0.5,0.5],a2[0.1,-0.3,0.3],a3[0, -0.5, 0.5]}",
    ]

tnpParAltSigFit = [
    "meanP[-0.0,-2.0,5.0]","sigmaP[1,0.7,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[1,0.5,5.0]", #bin 1 "meanP[-0.0,-4.0,5.0]
    "meanF[-0.0,-3.0,6.0]","sigmaF[0.5,0.7,3.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[1,0.5,5.0]",
    "acmsP[60.,50.,75.]","betaP[0.04,0.01,0.06]","gammaP[0.1, 0.005, 1.0]","peakP[90.0]", #bin 22/27 "betaP[0.04,0.001,0.5]","gammaP[0.1, 0.005, 1]","peakP[90.0]"--  bin1  #betaP[0.04,0.01,0.06]" 
    #"{a0[-0.9,-1.5,-0.5],a1[0.,-0.5,0.5],a2[0.,-0.1,0.1],a3[0, -0.1, 0.1]}", #bin 0
    #"{a0[-0.9,-1.5,-0.5],a1[0.,-0.5,0.5],a2[0.,-0.05,0.05],a3[0, -0.1, 0.1]}" #bin 1
    #"{a0[-0.9,-1.5,-0.5],a1[0.,-0.5,0.5],a2[0.,-0.1,0.1],a3[0, -0.05, 0.05]}", #bin /2/3/4/5/6/7
    #"{a0[-0.9, -1.0,-0.9],a1[0.,-0.3,0.3],a2[0.5,-0.4,0.4],a3[0, -0.01, 0.01]}", #bin 7
    #"acmsF[40.,50.,75.]","betaF[0.04,0.01,0.06]","gammaF[0.1, 0.005, 1.0]","peakF[90.0]", #bin 15 "betaF[0.04,0.01,0.2]",
    "{a0[-0.9,-1.5,-0.],a1[0.,-0.5,0.5],a2[0.,-0.09,0.09],a3[0, -0.1, 0.1]}", #bin 25
    ]
# "{a0[-0.5,-1.5,-0.2]
'''
#bin 22
tnpParAltSigFit = [
    "meanP[-0.0,-4.0,5.0]","sigmaP[1,0.7,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[1,0.5,5.0]", #bin 1 "meanP[-0.0,-4.0,5.0]
    "meanF[-0.0,-10.0,5.0]","sigmaF[0.5,0.7,6.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[1,0.5,10.0]",
    "acmsP[60.,50.,75.]","betaP[0.04,0.001,0.5]","gammaP[0.1, 0.005, 1.0]","peakP[90.0]", #bin 22 "betaP[0.04,0.001,0.5]","gammaP[0.1, 0.005, 1]","peakP[90.0]"--  bin1  #betaP[0.04,0.01,0.06]" 
    "acmsF[40.,50.,75.]","betaF[0.04,0.01,0.1]","gammaF[0.1, 0.005, 1.0]","peakF[90.0]",
    ]
'''
...
tnpParAltBkgFit = [
    #"meanP[-0.0,-5.0,5.0]","sigmaP[4.5,4.0,6.0]", #bin 2/3
    #"meanF[-0.0,-3.0,5.0]","sigmaF[0.9,0.5,3.0]",


    "meanP[-0.0,-5.0,5.0]","sigmaP[1.5,1.,5.0]",

    #"meanP[-0.0,-3.0,5.0]","sigmaP[1.5,1.,5.0]", #bin 28
    #"meanF[-0.0,-3.0,5.0]","sigmaF[0.9,0.5,3.0]",
    ...
    #"a0[2,0.5,7.5]","a1[2,10,40]","a2[7,2,60]", #bin 0/1/3/4/5 bin 25
    #"a0[2,0.5,30]","a1[2,3,20]","a2[7,2,70]", #bin 0/1
    #"a0[2,0.5,15.]","a1[2,10,40]","a2[55.,50,70]",
    ]
...
tnpParAltSigBkgFit = [
    ...
    "alphaP_2[0.,-5.,5.]",
    #"a0[0.9, 0.7, 2.0]","a1[40,35,50]","a2[58,50,60]", #bin 2
    #"a0[2,0.5,7.5]","a1[2,10,40]","a2[7,2,30]",#3/4/5/6/7
    "a0[2,0.5,7.]","a1[2,10,40]","a2[7,2,60]",#bin 25
    #"alphaF_2[0,-5., +5.]",
]
