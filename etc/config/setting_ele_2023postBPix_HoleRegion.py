...
tnpParNomFit = [
    ...
    "acmsP[60.,50.,80.]","betaP[0.05,0.01,0.2]","gammaP[0.1, -2, 2]","peakP[90.0]",#20-29  betaP[0.05,0.01,0.2]
    "acmsF[60.,50.,80.]","betaF[0.05,0.01,0.08]","gammaF[0.5, -2, 2]","peakF[90.0]",
    # "{a0[-0.9,-1.5,-0.5],a1[0.,-0.5,0.5],a2[0.,-0.09,0.09],a3[0, -0.5, 0.5]}", #bins 0/1/2
    ]
...
tnpParAltBkgFit = [
    ...
    "alphaP[0.,-5.,5.]",
    "alphaF[-0.,-5.,5.]",
    #"a0[2,0.5,7.5]","a1[2,10,40]","a2[7,2,60]", #bin 0/1/3/4/5
