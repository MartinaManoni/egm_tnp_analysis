...
tnpParNomFit = [
    ...
    "{a0[-0.9,-1.5,-0.5],a1[0.,-0.5,0.5],a2[0.,-1.0,1.0],a3[0, -0.5, 0.5]}",#bin 7
...
tnpParAltSigFit = [
    ...
    "meanP[-0.0,-5.0,5.0]","sigmaP[1,0.7,10.0]","alphaP[2.0,1.0,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[1,0.5,5.0]", #DY ID MARTINA #bin 18 /ALL DATA BINS
  ...
  # "{a0[-0.9,-1.5,-0.5],a1[0.,-0.5,0.5],a2[0.,-0.02,0.02],a3[0, -0.2, 0.2]}",#bin 0/1/3
   ...
   #"{a0[-1.0,-1.5,-0.2],a1[0.,-0.5,0.5],a2[0.,-0.03,0.03],a3[0, -0.2, 0.2]}",#bin 8
   "{a0[-1.0,-1.5,-0.0],a1[0.,-0.5,0.5],a2[0.,-0.02,0.02],a3[0, -0.2, 0.2]}",#bin 6/7

    #--Bernstein BKG
    #"a0[12., 1., 15.]", "a1[2, 0., 3.]", "a2[0.5., -0., 0.8.]", "a3[0.3, -0., 3.]", #Nominal lowpT bins 0/3/9 MARTINA
    #"a0[12., 1., 15.]", "a1[1.5, 0., 2.]", "a2[3.0, 2.5, 5.]", "a3[0.3, -0., 3.]", #Nominal lowpT bin 1/2/7 MARTINA
    #"a0[12., 1., 15.]", "a1[1.5, 0., 2.]", "a2[3.0, 2.0, 6.]", "a3[0.3, -0., 3.]", #Nominal lowpT bin 4/5 MARTINA
    #"a0[12., 1., 15.]", "a1[1.5, 0., 2.]", "a2[0.1., -0., 0.4.]", "a3[0.3, -0., 3.]", #Nominal lowpT bins 6 MARTINA
    # "a0[12., 1., 15.]", "a1[1.5, 0., 2.]", "a2[0.1., -0., 0.8]", "a3[0.3, -0., 3.]", #Nominal lowpT bins 8 MAR
    ]
...
tnpParAltBkgFit = [
   ...
   # "meanP[-0.0,-2.0,1.0]","sigmaP[0.9,0.5,5.0]",#bin 27
    ...
    #"a0[12., 1., 15.]", "a1[2., 0., 3.]", "a2[0.2, -0., 0.5]", "a3[0.3, -0., 3.]",  #bin 9/13/14/15/16
    ]
...
tnpParAltSigBkgFit = [
    ...
    "a0[5., 1., 20.]", "a1[2., 0., 3.]", "a2[0.2, -0., 0.5]", "a3[0.3, -0., 3.]",  #bin 0/3/4/5 8/9 13/14/15 OK
