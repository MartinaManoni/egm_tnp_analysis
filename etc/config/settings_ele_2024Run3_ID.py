...
tnpParNomFit = [
    ...
    "{a0[-0.9,-1.5,-0.2],a1[0.,-0.5,0.5],a2[0.,-1.0,1.0],a3[0, -0.5, 0.5]}",#bin  20/21/22/23
...
tnpParAltSigFit = [
  ...
  # "{a0[-0.9,-1.5,-0.5],a1[0.,-0.5,0.5],a2[0.,-0.02,0.02],a3[0, -0.2, 0.2]}",#bin 0/1/3
   ...
   #"a0[12., 1., 15.]", "a1[2., 0., 3.]", "a2[0.2, -0., 0.5]", "a3[0.3, -0., 3.]",
    ...
    "{a0[-0.9,-1.5,-0.2],a1[0.,-0.5,0.5],a2[0.,-0.9,0.9],a3[0, -0.5, 0.5]}",#bin 23

    #"{a0[-0.9,-1.5,-0.2],a1[0.,-0.5,0.5],a2[0.,-1.0,1.0],a3[0, -0.1, 0.1]}",#bin  20/21/22
